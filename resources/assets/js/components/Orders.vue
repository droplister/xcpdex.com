    ...
    <table class="table table-striped table-sm">
      ...
      <tbody>
        <tr v-for="order in orders">
          ...
          <td>{{ order.quantity }} <a :href="'/markets/' + order.market">{{ order.base_asset }}</a></td>
          <td>{{ order.price }} <a :href="'/markets/' + order.market">{{ order.quote_asset }}</a></td>
          <td>{{ order.total }} <a :href="'/markets/' + order.market">{{ order.quote_asset }}</a></td>
